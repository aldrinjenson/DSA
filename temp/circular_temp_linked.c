/* Program to implement a Circular Linked List in C */
#include <stdlib.h>
#include <stdio.h>
...
int insert_particular(int elem, int item) //To insert a node after a particular element, elem
{
...
int delete_particular(int elem) //To delete the particular element
{
...
int main()
{
  ...
  do
  {
    ...
    case 1:
      ...
      break;
    case 2:
      printf("Enter the particular item to be deleted: ");
      scanf("%d", &x);
